(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const o of t)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function n(t){const o={};return t.integrity&&(o.integrity=t.integrity),t.referrerPolicy&&(o.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?o.credentials="include":t.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(t){if(t.ep)return;t.ep=!0;const o=n(t);fetch(t.href,o)}})();const g=["countrybase","statistics","about"],v=["settings","educational","tutorial"],w="State of Mind";class C{constructor(){this._mobileMenuOpen=!1}render(){const e=document.createElement("div");e.classList.add("container");const n=this.createNavigation(g,"nav-left"),a=this.createNavigation(v,"nav-right"),t=this.createHeaderTitle(),o=this.createMobileMenu(),r=this.createMobileMenuButton(o);e.appendChild(n),e.appendChild(t),e.appendChild(a),e.appendChild(r),e.appendChild(o);const s=document.createElement("header");return s.classList.add("header"),s.appendChild(e),o.addEventListener("click",i=>{i.target.tagName==="a"&&(o.classList.remove("active"),burger.classList.remove("active"),document.body.style.overflow="",o.style.display="none")}),document.addEventListener("keydown",i=>{i.key==="Escape"&&this._mobileMenuOpen&&(o.classList.remove("active"),burger.classList.remove("active"),document.body.style.overflow="",o.style.display="none")}),window.addEventListener("resize",()=>{window.innerWidth>1100&&this._mobileMenuOpen&&(o.classList.remove("active"),burger.classList.remove("active"),document.body.style.overflow="",o.style.display="none")}),s}createNavigation(e,n){const a=document.createElement("nav");a.classList.add(n);const t=document.createElement("ul");return t.classList.add("nav-list"),e.forEach(o=>{const r=document.createElement("li"),s=document.createElement("a");s.setAttribute("data-nav",o),s.href=`/democracy-game/src/pages/${o}`,s.textContent=o,(o==="tutorial"||o==="educational")&&(s.addEventListener("click",function(i){i.preventDefault()}),s.style.opacity="0.5",s.style.cursor="not-allowed"),r.appendChild(s),t.appendChild(r)}),a.appendChild(t),a}createHeaderTitle(){const e=document.createElement("div");e.classList.add("header-title");const n=document.createElement("h1");n.classList.add("title-text");const a=document.createElement("a");return a.href="/democracy-game/src/pages/home",a.textContent=w,n.appendChild(a),e.appendChild(n),e}createMobileMenuButton(e){const n=document.createElement("button"),a=document.createElement("div");n.classList.add("mobile-menu-btn"),n.setAttribute("id","mobileMenuBtn"),n.setAttribute("aria-label","Toggle mobile menu"),a.classList.add("burger"),a.setAttribute("id","burger");for(let t=0;t<3;t++){const o=document.createElement("span");a.appendChild(o)}return n.appendChild(a),n.addEventListener("click",t=>{t.preventDefault(),a.classList.contains("active")?(a.classList.remove("active"),e.style.display="none",this._mobileMenuOpen=!1):(a.classList.add("active"),e.style.display="flex",this._mobileMenuOpen=!0)}),n}createMobileMenu(){const e=document.createElement("div");return e.classList.add("mobile-menu"),e.setAttribute("id","mobileMenu"),[...g,...v].forEach(a=>{const t=document.createElement("a");t.href=`/democracy-game/src/pages/${a}.html`,t.textContent=a,e.appendChild(t),a!=="educational"&&a!=="tutorial"||(t.addEventListener("click",function(o){o.preventDefault()}),t.style.opacity="0.5",t.style.cursor="not-allowed")}),e}}const k=[{name:"Classic Mode",route:"/gamemodeone",icon:"🎯",color:"var(--green-color)",info:"Given political system find every country within a certain period of time"},{name:"Figure Mode",route:"/gamemodethree",icon:"🧑",color:"var(--red-color)",info:"Given political system find every country within a certain period of time"},{name:"Drag n Drop",route:"/dragthecountry",icon:"🔶",color:"var(--orange-color)",info:"Drag the country shape to its correct political system"},{name:"Maple",route:"/gamemodefour",icon:"🗺️",color:"var(--purple-color)",info:"Guess the country by facts"}];function L(){const l=document.getElementById("gameModeModal");l&&l.remove();const e=document.createElement("div");e.id="gameModeModal",e.style.cssText=`
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
  ...
  `;const t=document.createElement("div");t.style.cssText=`
    ...
    gap: 1rem;
  `,k.forEach((i,x)=>{const c=document.createElement("div");c.style.cssText=`
